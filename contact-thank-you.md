...
<section class="hero">
  <div class="hero__grid">
    ...
    <aside class="hero-card">
      <span class="hero-card__label">What happens next</span>
      <h3>Best next moves after a first message.</h3>
      <ul class="check-list">
        <li>If the request is already clear, move to the full application.</li>
        <li>If the timing or structure is still unclear, book a call.</li>
        <li>If you want to prepare first, use the checklist below.</li>
      </ul>
    </aside>
  </div>
</section>
...
<section class="section split">
  <div class="panel">
    ...
    <div class="signal-list">
      ...
      <div>
        <strong>Need a live conversation</strong>
        <span>Book a short call if the structure or timing needs to be talked through directly.</span>
      </div>
    </div>
  </div>
