...
<section class="section split">
  ...
  <div class="proof-card">
    ...
    <ul class="plain-list">
      ...
      <li>Commercial refinance</li>
      <li>Construction and repositioning</li>
      <li>Bridge, recapitalization, mezzanine, and equity situations</li>
    </ul>
  </div>
</section>
...
<section class="section">
  <div class="cta-panel">
    <p class="eyebrow">Real Estate Path</p>
